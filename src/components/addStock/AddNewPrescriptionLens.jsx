...
import PrescriptionLensForm from './PrescriptionLensForm';
import { ContantLensValidation } from '@/utlis/formValidate';


function AddNewPrescriptionLens() {
    ...
    const handleSavePrescriptionLens = async (e) => {
        e.preventDefault();
    ...
    return (
        <div className='container mt-5'>
            ...
            {batchInfo.id && <>
                ...
                <PrescriptionLensForm lens={lens} setLens={setLens} images={images} setImages={setImages} handleSavePrescriptionLens={handleSavePrescriptionLens}  />

                <CurrentStatusComponent status={status} setStatus={setStatus} />

                {/* <button className="btn btn-primary" onClick={handleSavePrescriptionLens}>Submit</button> */}
...
export default AddNewPrescriptionLens